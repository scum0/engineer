...
extern "C" void engineer_arm_init(void* args)
{
    ...
    pyro::axis_target_pos_id[0] = global_databoard.get_topic_id("axis1_target_pos");
    pyro::axis_target_pos_id[1] = global_databoard.get_topic_id("axis2_target_pos");
    pyro::axis_target_pos_id[2] = global_databoard.get_topic_id("axis3_target_pos");
    pyro::axis_target_pos_id[3] = global_databoard.get_topic_id("axis4_target_pos");
    pyro::axis_target_pos_id[4] = global_databoard.get_topic_id("axis5_target_pos");
    pyro::axis_target_pos_id[5] = global_databoard.get_topic_id("axis6_target_pos");
    pyro::axis_target_pos_id[6] = global_databoard.get_topic_id("gripper_target_pos");
